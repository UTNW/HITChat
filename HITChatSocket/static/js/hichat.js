...
HiChat.prototype={
	init:function(){
		...
		this.socket.on("nickExisted",function(){
			layer.msg('对不起！用户名已被占用，请更换其他用户名！');
		...
		this.socket.on("system",function(userName,userList,userCount,type){
			...
			var system="<div class='system'><span class='msg'>系统消息：<span class='mark'>"+userName+" </span>"+status+"HITChat</span></div>";
		...
		this.socket.on("newShake",function(userName){
			var system="<div class='system'><span class='msg'>系统消息：O(∩_∩)O哈哈~<span class='mark'>"+userName+" </span> 发个抖窗</span></div>";
			ELE_SHOWBOX.append(system);
